...
this["JST"]["list"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"list\" data-id=\""
    ...
    + "</textarea><a class=\"list-hamburger\" href=\"#\"><span class=\"list-icon\">...</span></a></div><div class=\"list-cards\"><ul id=\"card-list\"></ul></div><div class=\"card-composer hide\"><form class=\"cardForm\" method=\"post\" action=\"/cards\"><div class=\"list-card composer\"><textarea name=\"title\" class=\"list-card-composer-textarea card-title\" dir=\"auto\" style=\"overflow: hidden; word-wrap: break-word; resize: none;\"></textarea></div><div class=\"card-add-controls\"><input class=\"primary save-edit\" type=\"submit\" value=\"Add\"><a class=\"cancel-edit\" href=\"#\"></a></div></form></div><a href=\"#\" class=\"open-card-composer\">Add a card...</a></div>";
},"useData":true});